...
namespace ServerLibrary.Repositories.Implementations
{
    public class UserAccountRepository(IOptions<JwtSection> config, AppDbContext appDbContext) : IUserAccount
    {
        ...
        public async Task<GeneralResponse> CreateAsync(Register user)
        {
            ...
            //Check assigned role
            var checkedAdminRole = await appDbContext.SystemRoles.FirstOrDefaultAsync(_ => _.Name!.Equals(Constants.Admin));
            if (checkedAdminRole is null)
            {
        ...
        public async Task<LoginResponse> SignInAsync(Login user)
        {
            ...
            //save the resfresh token to the database
        ...
        public async Task<LoginResponse> RefreshTokenAsync(RefreshToken refreshToken)
        {
            ...
            //refresh token found now update
        ...
        public async Task<GeneralResponse> DeleteUser(int id)
        {
            ...
            await appDbContext.SaveChangesAsync();
            return new GeneralResponse(true, "User removed successfully");
        }
